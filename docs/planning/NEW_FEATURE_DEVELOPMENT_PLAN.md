...
日期：2026-09-13。状态：提案，尚未实现。产品理由与排序见 [路线图](PRODUCT_EVOLUTION_ROADMAP.md)。所有实现以 [S00–S08 稳定性计划](V0_1_STABILIZATION_DEVELOPMENT_PLAN.md) 为前置基础。
...
优先级：第一批。预计 3–5 人日，分为导出 1–2 日、备份恢复 2–3 日两段交付。
...
| 批次 | 任务范围 | 可独立验收的成果 |
|---|---|---|
| NF-A | F01-1～F01-3 | 成稿导出，1–2 日 |
| NF-B | F02-1～F02-6 | 可选写前确认卡，3–5 日 |
| NF-C | F01-4～F01-6 | 本地备份恢复，2–3 日 |
| NF-D | F03-1～F03-7 | 修订工作单，4–6 日 |
| NF-E | F04-1～F04-7 | 素材依据卡，5–8 日 |

NF-A～NF-C 合计约 6–10 人日，建议作为稳定性收口后的第一轮候选交付，之后安排实际使用反馈。NF-D 与 NF-E 根据用户主要遇到“不会改”还是“依据不足”确定投入节奏，但 F04 的修订整合仍依赖 F03 的锚定基础。
