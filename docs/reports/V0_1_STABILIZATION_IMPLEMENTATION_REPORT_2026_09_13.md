...
- B09 自动检查 5,200 字中文剪贴板粘贴、保存后刷新、合成 composition、反向 Shift 连续选择、跨段 DOM 文字选择及 ¶2–3 提案范围；B10 已查看 1280×800 工作台与 1440×1000 快速写作截图，并验证 Escape 关闭对话框。没有把自动化剪贴板或合成事件当作原生输入法实测。
