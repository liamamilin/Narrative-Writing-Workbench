...
PROGRESSION_CONTRACT = (
    ...
    "- One beat must land the conceptual distinction on a concrete scene: "
    "show \"X is not Y, but Z\" happening in a specific situation, not as "
    "a definition sentence.\n"
    "- The closing beat delivers the Residue: whatever form "
    "reader_end_state took — a reframed distinction (X ≠ Y), the "
    "contradiction pushed one layer deeper, an earned open question, "
    "the real cost of the exposed structure, a concentrated image, or "
    "a portable distinction ONLY when the essay is genuinely about a "
    "reusable lens. Do NOT default to an imperative action-tool ending "
    "(\"以后遇到X,就问Y\" / \"下次看到X,先做Y\") unless the piece is an "
    "operational how-to; most observation/explanation/renaming essays "
    "should stop at the point of maximum tension. A closing that only "
    "summarizes, moralizes, or swells emotionally (总结陈词/鸡汤收束) "
