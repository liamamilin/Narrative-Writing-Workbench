...
PROGRESSION_CONTRACT = (
    ...
    "- The closing beat delivers the Residue: hand the reader the portable "
    "mental tool named in reader_end_state — something they can carry and "
    "reuse (工作/婚姻/教育/创作都会再用到). A closing that only "
